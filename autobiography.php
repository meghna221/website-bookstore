...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4">Autobiography</h1>
    <p class="lead">“Autobiography is a wound-where the blood of history does not dry.” </p>
  </div>
</div>
    <?php
     include "connection.php";
     $sql="select * from category where cat='autobiography'";
