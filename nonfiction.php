...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4">Non Fiction</h1>
    <p class="lead">“If uncovering the truth is the greatest challenge of nonfiction writing, it is also the greatest reward.”
      -Candice Millard</p>
  </div>
</div>
    <?php
     include "connection.php";
     $sql="select * from category where cat='non fiction'";
