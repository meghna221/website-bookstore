...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4">Fantasy</h1>
    <p class="lead">“One day, you will be old enough to start reading fairytales again.” </p>
  </div>
</div>
    <?php
     include "connection.php";
     $sql="select * from category where cat='fantasy'";
